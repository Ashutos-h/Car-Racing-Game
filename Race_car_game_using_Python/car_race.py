...
def game_init():
    pygame.init()
    pygame.display.set_caption('Road Fighter/Ashu')
    
def display(count, x, y, message_format = 'Current Score: %d'):
    """display the score"""
    font = pygame.font.SysFont("arial", 20)
    text = font.render(message_format%count, True, blue)
...
def crash(x, y):
    ...
    largeText = pygame.font.SysFont("Monotype Corsiva",80)
    ...
    while True:
        ...
        button("PLAY AGAIN", 200,250,150,50, green, bright_green, game_loop)
...
def game_pause():
    ...
    while pause:
        ...
        textSurf, textRect = text_object("Game Paused!", largeText)
        textRect.center = ((display_width/2) , (display_height/4))
        game_display.blit(textSurf, textRect)

        button("Continue !", 200,250,100,50, green, bright_green, game_unpause)
        button("Quit", 500,250,100,50, red, bright_red, quitgame)
...
def game_intro():
    ...
    while intro:
        ...
        largeText = pygame.font.SysFont("Monotype Corsiva",80)
        textSurf, textRect = text_object("Road Fighter", largeText)
        textRect.center = ((display_width/2) , (display_height/2))
        game_display.blit(textSurf, textRect)
        load_image(375, 100, 'images/car1.png')
...
def game_loop():
    ...
    while not gameExit:
        ...
        display(dodged, 5, 25)
        display(thing_speed*60, 5, 50, "Speed: %d Km/hr")
